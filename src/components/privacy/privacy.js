export default function Policy() {
    ...
    return (
        <div className="container px-sm-5 my-5">
            <div className="row">
                <div className="col-12">
                    <h1 className="text-black my-2">Privacy Policy</h1>

                    <b>Introduction</b>
                    <p className="my-3">
                        We are Northwave technology Solutions Limited (“northwave”), a Nigerian Company with office at
                    </p>
                    ...
                    <p className="my-3">
                        Northwave does not take your trusting us with your information for granted. The privacy of our Users is important to us and we are committed to safeguarding it. Hence, this Privacy Policy explains your Personal Information which we collect, why we collect it, and what we do with it.
                    </p>

                    <b>Overview</b>
                    <p className="my-3">
                        This Privacy Policy describes your privacy rights regarding how and when we collect, use, store, share and protect your information across our website, payment platforms (“Platforms”), Software Applications, (“Apps”), email notifications and tools regardless of how you use or access them.
                    </p>

                    <p className="my-3">
                        This Privacy Policy is applicable to all of the Website, software applications (“Apps”) and/or payment platforms (“Platforms”) offered by Northwave or affiliated companies collectively referred to as Northwave “services”.
                    </p>
                    ...
                    <p className="my-3">
                        Northwave: means Northwave Solutions Limited.
                    </p>
                    ...
                    <p className="my-3">
                        User: means an individual who uses the Services or accesses the Sites and has agreed to use the end services of Northwave.
                    </p>
                    ...
                    <p className="my-3">
                        Objective
                        This Privacy Policy statement is to provide all persons and organizations whose Personal Information we hold with description of the types of Personal Information we collect, the purposes for which we collect that Personal Information, the other parties with whom we may share it and the measures we take to protect the security of the data.
                    </p>
                    ...
                    <p className="my-3">
                        ...
                        Northwave focuses her principles on the following;
                    </p>

                    <p className="my-3">
                        To Empower the individual: Northwave wants you to be in charge of your personal information and to make your own voluntary choices about your Personal Information;
                        To keep and secure personal information: Northwave does not take your trusting us with your information for granted. We take full responsibility to ensuring that appropriate security measures are put in place and your personal information is protected;
                        ...
                        To abide by local laws: Northwave is a company with local privacy expertise. Our privacy practices may vary among the countries in which we operate to reflect local practices and legal requirements. Specific privacy notices may apply to some of our products and services. Please visit the webpage or digital asset of the specific product or service to learn more about our privacy and information practices in relation to that product or service;
                        To collect and store personal information on the “need to collect” basis: Northwave collects personal information to perform its services for you. We work to have measures in place to prevent collecting and storing Personal Information beyond what we need.
                    </p>
                    ...
                    <p className="my-3">
                        This Privacy Policy applies to Northwave services only. We do not exercise control over the sites displayed or linked from within our various services. These other sites may place their own cookies, plug-ins or other files on your computer, collect data or solicit personal information from you. Northwave does not control these third-party websites and we are not responsible for their privacy statements. Please consult such third parties’ privacy statements and set appropriate controls from your setting when using any third-party services.
                    </p>
                    ...
                    <p className="my-3">
                        Sign up for a Northwave Account;
                    ...
                    <p className="my-3">
                        ...
                        Process your payment transactions (including authorization, clearing, and other related dispute resolution activities);
                        Protect against and prevent fraud, unauthorized transactions, claims and other liabilities;
                        Provide, administer and communicate with you about products, services, offers, programs and promotions of Northwave, financial institutions, merchants and partners;
                        Evaluate your interest in employment and contact you regarding possible employment with Northwave;
                        ...
                        As may be required by applicable laws and regulations, including for compliance with Know Your Customers and risk assessment, Anti-Money Laundering, anti-corruption and sanctions screening requirements, or as requested by any judicial process, law enforcement or governmental agency having or claiming jurisdiction over Northwave and/or her affiliates;
                    ...
                    <p className="my-3">
                        ...
                        The security of your Personal Information is important to Northwave. We are committed to protecting the information we collect. We maintain administrative, technical and physical controls designed to protect the Personal Information you provide, or we collect against loss or theft, as well as against any unauthorized access, risk of loss, disclosure, copying, misuse or modification.
                    </p>
                    ...
                    <p className="my-3">
                        Northwave only shares personal information with External Third parties in the following limited circumstances:
                    </p>
                    ...
                    <p className="my-3">
                        ...
                        protect against imminent harm to the rights, property or safety of Northwave, its users or the public as required or permitted by law.
                        If Northwave becomes involved in a merger, acquisition, or any form of sale of some or all of its assets, we will provide notice before personal information is transferred and becomes subject to a different privacy policy.
                    </p>
                    ...
                    <p className="my-3">
                        Where you have any belief that Northwave has mistakenly or unknowingly collected information from a minor, please contact us using the information provided under the Contact Us section to enable investigate and restrict such data.
                    </p>

                    <p className="my-3">
                        10. International Data Transfers
                        Where Personal Information is to be transferred to a country outside Nigeria, Northwave shall put adequate measures in place to ensure the security of such Personal Information and to ensure same is done securely and in accordance with the Nigerian Data Protection Regulation.
                    </p>
                    ...
                    <p className="my-3">
                        12. Training
                        Northwave ensures that employees who collect, access and process Personal Information receive adequate data privacy and protection training in order to develop the necessary knowledge, skills and competence required to effectively manage the compliance framework under this Policy and the Nigerian Data Protection Regulation (NDPR) with regard to the protection of Personal Information. On an annual basis, Northwave develops a capacity building plan for its employees on data privacy and protection in line with the NDPR.
                    </p>
