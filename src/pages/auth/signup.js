...
export default function SignupPage() {
    // page default data
    const pageName = "NorthWave - Sign Up";
    const pageDesc = "Signup for your NorthWave account and start marketing Donate.";
    const baseURL = "https://northwaveng.com";
    const pageURL = "https://northwaveng.com/auth/signup";
